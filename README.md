<a href="/img/openMINDS-computation_logo_light.png">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="/img/openMINDS-computation_logo_dark.png">
    <source media="(prefers-color-scheme: light)" srcset="/img/openMINDS-computation_logo_light.png">
    <img alt="openMINDS computation metadata model" src="/img/openMINDS-computation_logo_light.png" title="Logo created by U. Schlegel, L. Zehl, C. Hagen Blixhavn" align="right" height="70">
  </picture>
</a>
...
There you can also explore directly the :arrow_right: [**openMINDS_computation schema specifications**][docu-computation-url].

## How to cite

For specifically referencing the openMINDS_computation metadata model, please use the following RRID Portal record:  
```
...
Schema contributions to openMINDS_computation should be raised and discussed on the :arrow_right: [**issue tracker**][issuetracker-computation]  
...
[contributors-url]: https://github.com/openMetadataInitiative/openMINDS_computation/graphs/contributors
[contributors-shield]: https://img.shields.io/github/contributors/openMetadataInitiative/openMINDS_computation
[docu-url]: https://openminds-documentation.readthedocs.io
[docu-computation-url]: https://openminds-documentation.readthedocs.io/en/v3.0/schema_specifications/computation.html
